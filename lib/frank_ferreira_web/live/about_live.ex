    ...
    <main class="mx-auto max-w-2xl px-4 sm:px-6 lg:px-8 py-24">
      ...
      <div class="mt-12 pt-8 border-t border-light-border dark:border-dark-border">
        ...
        <div class="flex items-center gap-5">
          ...
          >
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-label="Twitter @franknfjr">
          ...
          >
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-label="GitHub franknfjr">
              <path
                fill-rule="evenodd"
          ...
          >
            <svg class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24" aria-label="LinkedIn franknferreira">
